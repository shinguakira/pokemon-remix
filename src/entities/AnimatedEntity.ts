...
export abstract class AnimatedEntity extends Entity implements IAnimatable {
	...
	protected spriteOffsetX = 0;
	protected spriteOffsetY = -15;
	 ...
	 */
	setup(): void {
		this.frames = getFramePositions(this.cols, this.rows, this.tileWidth, this.tileHeight);
	 ...
	 */
	protected computeFrame(animData: AnimationData, deltaTime: number): FramePosition {
